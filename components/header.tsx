    ...
    <header
      ...
      <div className='flex h-20 md:h-28 justify-between items-center max-w-7xl mx-auto'>
        ...
        <nav className='hidden md:flex items-center space-x-10'>
          <Link href='/' className='text-white text-lg hover:text-primary transition-colors font-medium'>
            Trang chủ
          </Link>
          <Link href='#about-us' className='text-white text-lg hover:text-primary transition-colors font-medium'>
            Về chúng tôi
          </Link>
          <Link href='#games' className='text-white text-lg hover:text-primary transition-colors font-medium'>
            Trò chơi
          </Link>
          <Link href='#news' className='text-white text-lg hover:text-primary transition-colors font-medium'>
            Tin tức
          </Link>
        </nav>
        ...
        <Link
          href={'https://id.novagate.vn'}
          target='_blank'
          className='hidden md:block bg-primary hover:bg-[#d4a951] text-black font-semibold px-6 py-2 rounded-full transition-colors'>
          Tài khoản
        </Link>
        ...
        <div className='md:hidden flex items-center space-x-3'>
          <Link
            href={'https://id.novagate.vn'}
            target='_blank'
            className='bg-primary hover:bg-[#d4a951] text-black font-semibold px-4 py-2 rounded-full text-sm transition-colors'>
            Tài khoản
          </Link>
          <button
